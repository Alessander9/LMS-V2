...
@Component({
  selector: 'app-moxibustion-ventosas-presencial',
  standalone: true,
  imports: [CommonModule, RouterLink, NavbarComponent, FooterComponent],
  templateUrl: './moxibustion-ventosas-presencial.component.html',
  styleUrls: ['./moxibustion-ventosas-presencial.component.css']
})
export class MoxibustionVentosasPresencialComponent implements AfterViewInit, OnDestroy {
