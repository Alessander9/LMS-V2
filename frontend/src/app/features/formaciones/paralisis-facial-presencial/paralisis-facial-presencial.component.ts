...
@Component({
  selector: 'app-paralisis-facial-presencial',
  standalone: true,
  imports: [CommonModule, RouterLink, NavbarComponent, FooterComponent],
  templateUrl: './paralisis-facial-presencial.component.html',
  styleUrls: ['./paralisis-facial-presencial.component.css']
})
export class ParalisisFacialPresencialComponent implements AfterViewInit, OnDestroy {
