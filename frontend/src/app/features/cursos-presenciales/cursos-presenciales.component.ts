...
export class CursosPresencialesComponent {
  ...
  cursos: Curso[] = [
    ...
    },
    {
      ...
      rating: 4.9,
      duration: '1 mes / Presencial',
      description: 'Técnicas presenciales de lifting facial bioenergético, microagujas intradérmicas y rejuvenecimiento cutáneo no invasivo.',
      students: '+190',
      price: 'S/ 260/mes',
    ...
    },
    {
      ...
      description: 'Taller presencial intensivo de moxibustión directa/indirecta y ventosas de cristal y neumáticas para dolor y desbloqueo.',
      students: '+240',
      price: 'S/ 220',
    ...
    },
    {
      ...
      rating: 4.8,
      duration: '1 mes / Presencial',
      description: 'Cartografía podal completa, maniobras neuroreflejas de presión y secuencias para regulación del estrés y homeostasis.',
      students: '+210',
      price: 'S/ 230',
